$(document).ready(function () {
  let datos = {};
  let urlPdf = '';
  $.get('../DatosJson/Mu4.json', function (data) {
    console.log(data);
    ...
    let informacion = `<iframe width="560" height="315" src="https://www.youtube.com/embed/Pp-oJPilvAI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
