$(document).ready(function () {
    let datos = {};
    let urlPdf = '';
    $.get('../DatosJson/D2.json', function (data) {
      console.log(data);
      ...
      let informacion = `<iframe width="560" height="315" src="https://www.youtube.com/embed/P6pH3t0B8qI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
